      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div className="md:hidden px-4 pt-3">
          <div className="grid grid-cols-4 gap-2 rounded-xl border border-emerald-100 bg-white p-2">
            <button className={`rounded-lg px-2 py-2 text-center text-xs font-semibold ${activePanel === 'dashboard' ? 'bg-emerald-700 text-white' : 'bg-emerald-50 text-emerald-800'}`} onClick={() => openPanel('dashboard')} type="button">Home</button>
            <button className={`rounded-lg px-2 py-2 text-center text-xs font-semibold ${activePanel === 'bookings' ? 'bg-emerald-700 text-white' : 'bg-emerald-50 text-emerald-800'}`} onClick={() => openPanel('bookings')} type="button">Queue</button>
            <button className={`rounded-lg px-2 py-2 text-center text-xs font-semibold ${activePanel === 'earnings' ? 'bg-emerald-700 text-white' : 'bg-emerald-50 text-emerald-800'}`} onClick={() => openPanel('earnings')} type="button">Payouts</button>
            <button className={`rounded-lg px-2 py-2 text-center text-xs font-semibold ${activePanel === 'profile' ? 'bg-emerald-700 text-white' : 'bg-emerald-50 text-emerald-800'}`} onClick={() => openPanel('profile')} type="button">Profile</button>
          </div>
        </div>
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8 bg-transparent" ref={contentRef}>
          ...
          {activePanel === 'bookings' ? (
            <>
              <h2 className="font-h2 text-h2 text-primary">Bookings Queue</h2>
          ...
          {activePanel === 'earnings' ? (
            <>
              <h2 className="font-h2 text-h2 text-primary">Earnings & Payouts</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass-card rounded-xl p-md">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="material-symbols-outlined text-primary-container bg-primary-fixed p-2 rounded-lg">payments</span>
