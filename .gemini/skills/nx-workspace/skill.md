...
nx show projects --projects "backend/apps/*"
...
```json
{
  "root": "backend/apps/my-app",
  "name": "my-app",
  "sourceRoot": "backend/apps/my-app/src",
  "projectType": "application",
  "tags": ["type:app", "scope:client"],
  "targets": {
    "build": {
      "executor": "@nx/vite:build",
      "options": { "outputPath": "dist/backend/apps/my-app" }
    },
    "serve": {
  ...
  "graph": {
    "nodes": {
      "my-app": {
        "name": "my-app",
        "type": "app",
        "data": { "root": "backend/apps/my-app", "tags": ["type:app"] }
      },
      "shared-ui": {
        "name": "shared-ui",
        "type": "lib",
        "data": { "root": "backend/libs/shared-ui", "tags": ["type:ui"] }
      }
    },
    "dependencies": {
